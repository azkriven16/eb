      ...
      <div className="flex-1 pt-[350px] sm:pt-[450px] md:pt-[700px] lg:pt-20">
        <div className="space-y-5">
          ...
          <p className="subheading">
            ...
            — and recently graduated with an Bachelor of Science in Information
            Technology degree in 2025 . Over the years, I’ve gained experience
            through internships and part-time work at companies like{" "}
            <Highlighter
              action="box"
